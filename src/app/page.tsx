    ...
    <>
      ...
      ----------------------------------------------------------------------------------------- */}
        ...
        ----------------------------------------------------------------------------------------- */}
          ...
          <section
            id="problem"
            className="py-24 md:py-32 relative bg-black border-t border-zinc-900 overflow-hidden transform-gpu"
          >
              ...
              <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-center">
                ...
                <div className="order-1 md:order-2 flex flex-col items-start">
                  ...
                  <p className="text-lg text-zinc-400 leading-relaxed mb-8 md:mb-10 font-medium">
                    Service providers rely on you forgetting. That 7-day trial
                    inevitably turns into a recurring monthly charge. Before you
                    realize it, you have paid for a year of service you never
                    utilized.
                  </p>
            ...
            <div className="container mx-auto max-w-7xl px-6">
              ...
              <div className="grid md:grid-cols-3 gap-12 relative">
                ...
                <div className="relative flex flex-col items-center text-center group">
                  ...
                  <p className="text-zinc-400 leading-relaxed max-w-xs text-sm md:text-base">
                    See your monthly burn rate. Identify duplicate costs.
                    Optimize your spending velocity and save money.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="w-full md:w-1/3">
                  <div className="sticky top-32">
                    ...
                    <p className="text-zinc-400 text-lg mb-8 leading-relaxed">
                      Technical and operational specifics regarding the
                      SubVantage tracking engine.
                    </p>
          ...
          <section className="py-32 px-4 sm:px-6 text-center bg-black relative overflow-hidden transform-gpu border-t border-zinc-900">
            ...
            <div className="container mx-auto max-w-4xl relative z-10 flex flex-col items-center">
              ...
              <p className="text-lg md:text-xl text-zinc-400 mb-12 max-w-2xl mx-auto font-medium leading-relaxed">
                Join the users who are optimizing their cash flow. Set up your
                dashboard in minutes and never pay for an unwanted renewal
                again.
              </p>
